  ...
  <Layout>
    <div className="contacts-page">
      <div
        ...
        style={{
          backgroundImage: `url(${props.data.map.childImageSharp.fluid.src})`,
        }}
      />
      <section className="contacts-page__info">
        <h1>Контакты</h1>
        ...
        <br />
        <div className="contacts-page__phone-email">
        ...
        <div className="contacts-page__maps">
          <div className="contacts-page__map-links">
            <span>
              <a
...
export const fluidContactsImage = graphql`
  fragment fluidContactsImage on File {
    childImageSharp {
      fluid(maxWidth: 900) {
